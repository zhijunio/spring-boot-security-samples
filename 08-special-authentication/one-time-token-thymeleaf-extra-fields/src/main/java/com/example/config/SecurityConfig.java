...
public class SecurityConfig {
    ...
    @Bean
    GenerateOneTimeTokenRequestResolver generateOneTimeTokenRequestResolver(UserService users,
            PasswordEncoder passwordEncoder) {
        return new PasswordGenerateOneTimeTokenRequestResolver(users, passwordEncoder);
    }
